...
# Project:  ../pcap-test/pcap-test.pro
# Template: app
# Command: /opt/Qt/6.1.2/gcc_64/bin/qmake -o Makefile ../pcap-test/pcap-test.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I../pcap-test -I. -I/opt/Qt/6.1.2/gcc_64/mkspecs/linux-g++
...
DISTDIR = /home/kali/build-pcap-test-Desktop_Qt_6_1_2_GCC_64bit-Debug/.tmp/pcap-test1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lpcap   
AR            = ar cqs
...
DIST          = /opt/Qt/6.1.2/gcc_64/mkspecs/features/spec_pre.prf \
		...
		/opt/Qt/6.1.2/gcc_64/mkspecs/features/qml_debug.prf \
		...
		../pcap-test/pcap-test.pro  ../pcap-test/pcap-test.c
...
Makefile: ../pcap-test/pcap-test.pro /opt/Qt/6.1.2/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt/6.1.2/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/sanitize.conf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/common/gcc-base.conf \
		...
		/opt/Qt/6.1.2/gcc_64/mkspecs/features/yacc.prf \
		/opt/Qt/6.1.2/gcc_64/mkspecs/features/lex.prf \
		../pcap-test/pcap-test.pro
	$(QMAKE) -o Makefile ../pcap-test/pcap-test.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
pcap-test.o: ../pcap-test/pcap-test.c 
	$(CC) -c $(CFLAGS) $(INCPATH) -o pcap-test.o ../pcap-test/pcap-test.c
